...
export default function Button({
  ...
  const baseClasses =
    "flex justify-center items-center px-6 py-3 rounded-sm text-xs sm:text-base transition-all duration-200 min-h-0 min-w-0 cursor-pointer text-left whitespace-nowrap select-none gap-2";

  const variantClasses = {
    primary:
      "text-white font-medium bg-action hover:opacity-90 shadow-xs",

...
function Hero(): React.JSX.Element {
  return (
    <section className="w-full relative overflow-visible mx-auto">
      <div
        className="absolute top-0 left-0 w-full h-[100vh] bg-cover bg-[position:65%_center] md:bg-right-center bg-no-repeat z-1"
        style={{
      ...
      />
      <div className="relative z-2 w-full h-[100vh] flex flex-col justify-center mx-auto max-w-7xl px-6">
